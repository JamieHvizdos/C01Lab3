...
function App() {
  ...
  //Keep all the notes that don't have the notes._id set by the deleteNote methd
  const deleteNoteState = (entryId) => {
    setNotes((prevNotes) => prevNotes.filter((note) => note._id !== entryId))
  }
